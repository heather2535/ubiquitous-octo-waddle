      ...
      <div className="container ">
        <div className="grid gap-6 lg:grid-cols-1 lg:gap-12 items-center">
          <div className="space-y-4">
            ...
            Classifying Political Bias in News Media
          ...
          <p className="text-[20px] font-light"> Skills: Machine Learning, Text Classification, Full-Stack Development
                      <br/>Tools: Python, Scikit-Learn, Flask, HTML</p>
          <Link href="https://github.com/bellad21992/Predicting-Political-Bias-with-ML-Algorithms" passHref>
            <Button 
          ...
          <p className="font-[20px] font-light">This project uses supervised learning methods to classify and predict political bias or leaning in news media. The goal of the project is to train a model and implement it into an interactive user interface which allows users to enter a url, returning the bias prediction for the content of the article. As political bias persists in our news media, it becomes increasingly important to create and implement a tool which can accurately tell users whether an article is biased and if so, towards which party. The web app and models developed in this project can be used by anyone across the political spectrum to better inform readers of the bias around the news they consume.</p>
